...
<head>
    ...
    <!-- Favicon -->
    <link rel="icon" type="image/x-icon" href="{{isset($setting) ? asset('images/'. $setting->logo) : ''}}" />
    ...
    <div class="authentication-inner py-4">
      ...
      <div class="card">
        <div class="card-body">
          ...
          <!-- /Logo -->
          <h4 class="mb-1 pt-2">Welcome To Site! 👋</h4>
          <p class="mb-4">Please sign-in to your account and start the adventure</p>

            @if($errors->any())
            <div class="fv-plugins-message-container invalid-feedback" style="display: block;">
                <div data-field="email-username" data-validator="notEmpty">{{$errors->first()}}</div>
            </div>
            @endif

           

          <form id="formAuthentication" class="mb-3" action="{{ route('custom_login') }}" method="POST">
            @csrf
            <div class="mb-3">
              <label for="email" class="form-label">Email</label>
              <input type="text" class="form-control" id="email" name="email" value="{{old('email')}}" required placeholder="Enter your email or username" autofocus>
            </div>
            <div class="mb-3 form-password-toggle">
              ...
              <div class="input-group input-group-merge">
                <input type="password" id="myInput" class="form-control" value="{{old('password')}}" required name="password" placeholder="&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;" aria-describedby="password" />
                <span class="input-group-text cursor-pointer" onclick="myFunction()"><i class="ti ti-eye-off"></i></span>
              </div>
            </div>
            <div class="mb-3">
