...
<div class="container user-page">
    ...
    <form id="myForm" autocomplete="off" class="needs-validation" novalidate method="POST" action="{{route('customer.store')}}" data-type="customers" enctype="multipart/form-data" onsubmit="return validatePassword()">
                    ...
                    <div class="d-flex mob-changeImg col-lg-12">
                        <div class="col-lg-6">
                            <div class="form-input d-flex flex-column">
                                ...
                                <input name="name" type="text" placeholder="اسم العميل" value="" />
                            </div>
                            <div class="form-input d-flex flex-column">
                                <label class="mb-2" for="phone"> رقم الهاتف <span style="color: red;">*</span></label>
                                <input name="phone" type="text" placeholder="رقم الهاتف "value=""  />
                            </div>
                        </div>

                        <div div class="col-lg-6 d-flex align-items-center justify-content-center">
                            <div class="text-center">
                                <div class="position-relative d-inline-block w-300" style="width: 180px;">
                                    <input class="form-control dropify" name="image"
                                        data-default-file="{{url('upload/customer/customer.png')}}"
                        ...
                        <div class="row">
                            <div class="col-lg-4">
                                <div class="form-input d-flex flex-column">
                                    ...
                                    <input type="text" class="form-control" id="country" required name="country" value=""
                            ...
                            <div class="col-lg-4">
                                <div class="form-input d-flex flex-column">
                                    ...
                                    <input type="text" class="form-control" id="city" name="city" value=""placeholder="اكتب اسم المدينة">
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="form-input d-flex flex-column">
                                    <label class="mb-2" for="region"> الحي</label>
                                    <input type="text" class="form-control" id="region" name="region" value="" placeholder="اكتب اسم الحي">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="user-info flex-fill">
                    ...
                    <div class="container my-4">
                        <div class="col-lg-12 mb-3">
                            <div class="form-input d-flex flex-column">
                                <label required for="type">نوع العميل <span class="required-astric"
                                    style="color: #e60d0d;font-size: 18px;margin-right: 5px;">*</span> </label>
                        ...
                        <div class="form-input d-flex flex-column">
                            ...
                            <input type="text" name="customer_number" required value="{{$customer_number}}" readonly
                                class="form-control" id="file_number" placeholder="اسم العميل">
                        </div>
                    </div>
                    <div class="user-info flex-fill" id="nationalcontainer">
                        ...
                        <div class="container my-4">
                            <div class="form-input d-flex flex-column">
                                ...
                                <input type="text" name="national_id" value="" class="form-control" id="national_id">
                            </div>
                            <div class="form-input d-flex flex-column"> 
                                  <label for="national_image"> صورة الهوية </label>
                                <input type="file" name="national_image" class="form-control" id="national_image">
                            </div>
                        </div>
                        <!-- end card body -->
                    </div>
                    <div class="user-info flex-fill" id="taxcontainer">
                        ...
                        <div class="container my-4">
                            <div class="form-input d-flex flex-column">
                                ...
                                <input type="text" name="tax_number2" value="" required
                                    class="form-control" id="tax_number2">
                            </div>
                            <div class="form-input d-flex flex-column">
                                <label for="tax_number"> السجل التجاري</label>
                                <input type="text" name="tax_number" value="" required
                                    class="form-control" id="tax_number">
                            </div>
                            <div class="form-input d-flex flex-column">
                                 <label for="tax_image"> صورة السجل التجاري </label>
                                <input type="file" name="tax_image" class="form-control" id="tax_image">
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="form-input d-flex flex-column">
                                    ...
                                    <input name="email" type="text" placeholder="اكتب البريد الإلكتروني هنا" value=""
                                        onChange="" />
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="form-input d-flex flex-column">
                                    ...
                                    <input name="password" type="password" placeholder="اكتب كلمة المرور هنا" value="" onChange="" />
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="form-input d-flex flex-column">
                                    <label class="mb-2" for="confirmPassword"> تأكيد كلمة المرور </label>
                                    <input name="confirmPassword" id="confirmPassword" type="password" placeholder="اكتب تأكيد كلمة المرور هنا" value="" onChange="validatePassword()" />
                                </div>
                            </div>
                        </div>
                    </div>
